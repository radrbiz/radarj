...
public class Base58 {
    ...
    public static byte[] decode(String input) throws RadarException {
        if (input.length() == 0) {
            return new byte[0];
        }
    ...
    public static BigInteger decodeToBigInteger(String input) throws RadarException {
     ...
     *
     * @throws org.radarlab.core.exception.RadarException if the input is not base 58 or the checksum does not validate.
     */
    public static byte[] decodeChecked(String input) throws RadarException {
